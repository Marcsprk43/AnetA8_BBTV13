...
#define STRING_CONFIG_H_AUTHOR "(Marc van Zyl, Anet config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Marc's SKR"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 22, 9, -0.6 }
...
#define PREHEAT_1_TEMP_HOTEND 193
